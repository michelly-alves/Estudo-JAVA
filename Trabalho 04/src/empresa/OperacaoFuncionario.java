...
public class OperacaoFuncionario {
	...
	public static Boolean verificaDados(Funcionario[] vet, int N, String dataNascimento, String cpf, String nome,
			char sexo, String dataAdmissao) {
		int i = 0;
		Boolean verifica = true;
		for (i = 0; i < N; i++) {
			if (vet[i].validaCpf(cpf) == true && vet[i].validaDataAdmissao(dataAdmissao) == true
					&& vet[i].validaDataNascimento(dataNascimento) == true
	...
	public static void imprimeIdadeMaiorMenor(Funcionario[] vet, String dataNascimento, int N) {
		double menorIdade = vet[0].calculaIdade(dataNascimento);
		double maiorIdade = vet[0].calculaIdade(dataNascimento);
		...
		System.out.println("O Funcionario de maior Idade é: " + vet[indice].getNome() + " com a idade: " + maiorIdade
				+ " e o de menor idade é: " + vet[indice2].getNome() + " com  a idade: " + menorIdade);
